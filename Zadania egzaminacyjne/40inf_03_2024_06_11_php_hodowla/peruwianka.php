...
<div id="blokGlowny">
    <img src="pliki11/peruwianka.jpg" alt="Świnka morska rasy peruwianka">
    <?php
    //skrypt 2
    $db = mysqli_connect("localhost", "root", "", "hodowla");
    $query = "SELECT DISTINCT s.data_ur, s.miot, r.rasa FROM swinki as s JOIN rasy as r WHERE r.id=1;";
